...
model = {
    ...
    "ldnn_model": "src.models.sequence.LdnnSequenceModel",      #paper LDNN
}

layer = {
    "dss": "src.models.sequence.ss.standalone.dss.DSS",
    "ldnn_multihead_A_complex": "src.models.sequence.ss.standalone.ldnn_multihead_A_complex.SSM",   #LDNN multi head, only A is complex number, simple bidirectional
}
