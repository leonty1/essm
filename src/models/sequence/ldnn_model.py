...
from src.models.sequence.ldnn_block import SequenceResidualBlock
...
class LdnnSequenceModel(SequenceModule):
    def __init__(
        self,
        ...
        # Duplicate layers
        layers = layer * n_layers           #list * int = list, USED TO DUPLICATE LAYERS
